...
@router.get("/about", response_class=HTMLResponse, dependencies=[Depends(rate_limiter)])
async def about_page(request: Request):
    try:
        ...
        logger.debug(f"About page data: {data}")
        ...
        logger.error(f"Error loading about page: {traceback.format_exc()}")
