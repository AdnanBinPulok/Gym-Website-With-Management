...
@router.get("/schedule", response_class=HTMLResponse, dependencies=[Depends(rate_limiter)])
async def schedule_page(request: Request):
    try:
        ...
        logger.debug(f"Schedule page data: {data}")
        ...
        logger.error(f"Error loading schedule page: {traceback.format_exc()}")
