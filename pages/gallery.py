...
@router.get("/gallery", response_class=HTMLResponse, dependencies=[Depends(rate_limiter)])
async def gallery_page(request: Request):
    try:
        ...
        logger.debug(f"Gallery page data: {data}")
        ...
        logger.error(f"Error loading gallery page: {traceback.format_exc()}")
