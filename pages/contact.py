...
@router.get("/contact", response_class=HTMLResponse, dependencies=[Depends(rate_limiter)])
async def contact_page(request: Request):
    try:
        ...
        logger.debug(f"Contact page data: {data}")
        ...
        logger.error(f"Error loading contact page: {traceback.format_exc()}")
